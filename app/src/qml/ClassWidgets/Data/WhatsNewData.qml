    ...
    property var features: [
        {
            ...
            "description": qsTr("Introducing our brand new feature introduction page that allows users to quickly learn about the latest features of Class Widgets Next.0. Supports multi-page display, smooth animations, and smart navigation for a better new user experience."),
