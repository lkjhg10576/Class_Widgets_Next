            ...
            Image {
                ...
                source: {
                    switch (UpdaterBridge.status) {
                        case "UpToDate":
                            return PathManager.images("icons/cwn_up_to_date.png")
                        case "UpdateAvailable":
                            return PathManager.images("icons/cwn_update_available.png")
                        case "Downloading":
                            return PathManager.images("icons/cwn_update.png")
                        case "Downloaded":
                            return PathManager.images("icons/cwn_update.png")
                        case "Installing":
                            return PathManager.images("icons/cwn_settings.png")
                        case "Error":
                            return PathManager.images("icons/cwn_error.png")
                        default:
                            return PathManager.images("icons/cwn_update.png")
                    }
                }
